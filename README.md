...
<h2> THỜI GIAN, TIẾN ĐỘ THỰC HIỆN DỰ ÁN </h2>
     <body>
          ...
          <p> <em>Nội dung hoạt động của dự án: </em> </p>
          <ul>
          ...
          <p> <em>Địa điểm: </em>Các nơi vùng xa chưa được tiếp xúc với công nghệ mới và hiện đại hoặc những nơi có nhu cầu tìm hiểu về máy móc thông minh.</p>
...
<h2> KẾ HOẠCH TÀI CHÍNH CHO MỘT CHƯƠNG TRÌNH CỦA DỰ ÁN </h2>
     <body>
     <p> <strong><em> Nguồn vốn: </em></strong> </p>
     <ol>
     ...
     <p> <strong><em> Nguồn chi: </em></strong> </p>
     <table>
  <tr>
  ...
  <tr>
    ...
    <td>5.000.000đ</td>
     ...
     <p> <strong><em> Tổng cộng: 8.550.000đ </em></strong> </p>
      <table>
  <tr>
  ...
  <tr>
    ...
    <td>5.000.000đ</td>
     ...
     <p> <strong><em>  Tổng cộng: 51.325.000đ </em></strong> </p> 
    <p> <strong><em> Lợi nhuận: </em></strong> </p>
    <ul>
